...
public class ServerAuction {
    ...
    public static void main(String[] args) {
        ...
        try (ServerSocket serverSocket = new ServerSocket(PORT)) {
            ...
            System.out.println("Enter the item name and starting amount (e.g., 'item_name 100'): ");
    ...
    private static class ClientHandler extends Thread {
        ...
        public void run() {
            try {
                out.println("Welcome to Auction for " + itemName + ". Starting amount: " + startingAmount);
                out.println("Enter your username and bid amount in the format 'username amount': ");
                String input;
                while ((input = in.readLine()) != null) {
                    System.out.println("Client " + input + " Says: " + input);
